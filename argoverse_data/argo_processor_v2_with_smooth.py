...
from smooth import Kalman_traj_smooth
...
class ArgoverseInputDataProcessor(Dataset):
    ...
    def process(self, data):
        ...
        for traj, step in zip(data['trajs'], data['steps']):
            ...
            future_trajectory = trajectory[step >= self.obs_horizon]
            
            location = self.get_future_location_relative_with_current_position(
            future_trajectory,
            future_step,
            target_orig
            )
