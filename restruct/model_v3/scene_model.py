...
from model_v3.vectornet import VectorNet
from model_v3.layers import Dense
from model_v3.decoder import Decoder
import numpy as np
...
class SceneModel(nn.Module):
    def __init__(
        ...
        self.target_agent_encoder_layer = nn.TransformerEncoderLayer(
            d_model=hidden_size,
            nhead=8,
            dropout=0.1,
            batch_first=True
    ...
    def forward(
        ...
        target_agent_feature_embedding = self.t2a(target_agent_feature_embedding, agents_feature_embedding,
                                                  t2a_cross_mask)
